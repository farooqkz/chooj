...
function StepTwo() {
  return (
    <div className="step">
      <p>
        Users of each homeserver can communicate with the users of the same homeserver. But there's more! Users of different homeservers can communicate together, too!
      </p>
      <div>
        ...
        <img src={userIcon} height={14} width={14} alt="" style={{ bottom: "-16vh", left: "-8vw" }}/>
        <img src={userIcon} height={14} width={14} alt="" style={{ bottom: "-5vh", left: "-16vw" }}/>
        <img src={serverIcon} height={24} width={24} alt="" style={{ bottom: "-12vh", left: "-10vw" }} />
        <img src={userIcon} height={14} width={14} alt="" style={{ bottom: "12vh", left: "-18vw" }}/>
        <img src={userIcon} height={14} width={14} alt="" style={{ bottom: "12vh", left: "8vw" }}/>
        <img src={serverIcon} height={24} width={24} alt="" style={{ bottom: "-12vh" }}/>
        <img src={userIcon} height={14} width={14} alt="" style={{ bottom: "-16vh", left: "6vw" }}/>
        <img src={userIcon} height={14} width={14} alt="" style={{ bottom: "-5vh" }} />
      </div>
    </div>
  );
}
