  ...
  return (
    <div className="step">
      ...
      <div>
        ...
        <img style={{ left: "-25vw" }} src={userIcon} height={18} width={18} alt="" />
        <img style={{ left: "19vw" }} src={userIcon} height={18} width={18} alt="" />
        <img style={{ left: "-15vw", bottom: "-12vh" }} src={userIcon} height={18} width={18} alt="" />
      </div>
    </div>
  );
}
